...
class FdoNotificationDaemon {
    ...
    NotifyAsync(params, invocation) {
        ...
        if (replacesId !== 0 && this._notifications.has(replacesId)) {
            ...
            source = app ? this._getSourceForApp(sender, app)
        ...
        // Only fallback to 'app-name' and 'app-icon' when the source doesn't have a valid app
        const sourceGIcon = source.app ? null : this._iconForNotificationData(appIcon);
        source.processNotification(notification, !source.app ? appName : null, sourceGIcon);
...
class FdoNotificationDaemonSource extends MessageTray.Source {
    ...
    processNotification(notification, appName, appIcon) {
        ...
        // Acknowledge notifications that are resident and there app has the
