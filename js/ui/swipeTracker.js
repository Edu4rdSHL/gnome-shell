...
export const SwipeTracker = GObject.registerClass({
    ...
    Signals: {
        ...
        'swipe-end':    {param_types: [GObject.TYPE_UINT64, GObject.TYPE_DOUBLE]},
    },
    ...
    _interrupt() {
        this.emit('swipe-end', 0, this._cancelProgress);
    ...
    _beginPanGesture(panGesture) {
        const coords = panGesture.get_begin_centroid_abs();
    ...
    _updatePanGesture(panGsture, deltaX, deltaY, _pannedDistance) {
    ...
    _endGesture(velocity, distance, isTouchpad) {
        ...
        this._reset();
        this.emit('swipe-end', duration, endProgress);
    }
