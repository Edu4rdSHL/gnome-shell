...
static void
pan_recognize_cb (ClutterPanGesture *pan_gesture,
                  StScrollBar       *self)
{
  StScrollBarPrivate *priv = st_scroll_bar_get_instance_private (self);
  graphene_point_t centroid;
...
static void
pan_end_cb (ClutterPanGesture *pan_gesture,
            StScrollBar       *self)
{
  StScrollBarPrivate *priv = st_scroll_bar_get_instance_private (self);
...
static void
pan_cancel_cb (ClutterPanGesture *pan_gesture,
               StScrollBar       *self)
{
  StScrollBarPrivate *priv = st_scroll_bar_get_instance_private (self);
...
st_scroll_bar_init (StScrollBar *self)
{
  ...
  g_signal_connect (priv->handle_pan_gesture, "recognize",
                    G_CALLBACK (pan_recognize_cb), self);
  ...
  g_signal_connect (priv->handle_pan_gesture, "end",
                    G_CALLBACK (pan_end_cb), self);
  g_signal_connect (priv->handle_pan_gesture, "cancel",
                    G_CALLBACK (pan_cancel_cb), self);
